...
func (x *Reository) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Reository) ProtoMessage() {}

func (x *Reository) ProtoReflect() protoreflect.Message {
	mi := &file_repositories_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Reository.ProtoReflect.Descriptor instead.
func (*Reository) Descriptor() ([]byte, []int) {
	return file_repositories_proto_rawDescGZIP(), []int{1}
}

func (x *Reository) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *Reository) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Reository) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *Reository) GetOwner() *User {
	if x != nil {
		return x.Owner
	}
	return nil
...
type RepoGetReply struct {
	...
	Repo []*Reository `protobuf:"bytes,1,rep,name=repo,proto3" json:"repo,omitempty"`
}
...
func (x *RepoGetReply) GetRepo() []*Reository {
	if x != nil {
		return x.Repo
	}
	return nil
...
var file_repositories_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x45, 0x5a, 0x43, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x59, 0x6f, 0x75, 0x6e, 0x67, 0x73, 0x6f, 0x6f, 0x6e,
	0x4c, 0x65, 0x65, 0x2f, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x61, 0x6c, 0x2d, 0x67, 0x6f,
	0x2f, 0x63, 0x68, 0x30, 0x38, 0x2f, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x65, 0x2d, 0x73,
...
var file_repositories_proto_goTypes = []interface{}{
	...
	(*Reository)(nil),      // 1: Reository
	(*RepoGetReply)(nil),   // 2: RepoGetReply
	(*User)(nil),           // 3: User
}
var file_repositories_proto_depIdxs = []int32{
	3, // 0: Reository.owner:type_name -> User
	1, // 1: RepoGetReply.repo:type_name -> Reository
