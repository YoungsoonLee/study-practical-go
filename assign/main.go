...
func getPassword(r io.Reader, w io.Writer) (string, error) {
	msg := "your password please? press the enter key when done.\n"
	fmt.Fprintf(w, msg)
	...
	if len(password) == 0 {
		return "", errors.New("You didn't enter your password")
	}
	return password, nil
}
